...
for path in directories:
    ...
    for i in range(5):
        ...
        X_train=np.load('./'+path+'/Data/X_train_Original_'+str(i)+'.npy')
        X_test=np.load('./'+path+'/Data/X_test_Original_'+str(i)+'.npy')
    ...
    #%%%
    np.save('Performance_Original_'+path+'_train',np.array(data_accur))
    np.save('Performance_Original_'+path+'_test',np.array(data_accur2))
